...
const initialIntangibleAsset = {
  ...
  value: 0,
  date_end: "",
  name: "" // Ahora cumple con el tipo PayMethod
};
      ...
      <div class="mt-4">
        ...
        <div class="sm:flex gap-4 mt-4">
          ...
          <div :hidden="intangibleAsset.is_legal !== true" class="w-full mt-4 sm:mt-0">
            ...
            <TextInput v-model="intangibleAsset.vaucher" type="text" class="mt-1 w-full" placeholder="001-001-098765432"
              max="17" />
        ...
        <div class="sm:flex gap-4 mt-4">
          <div class="w-full">
            ...
            <TextInput v-model="intangibleAsset.period" type="number" class="mt-1 w-full" value="5" disabled />
