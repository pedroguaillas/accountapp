...
<template>
  <DialogModal :show="show" maxWidth="lg" @close="$emit('close')">
      ...
      <div class="mt-4">
        <form class="w-2xl grid grid-cols-1 gap-3" @keydown.enter.prevent="focusNextField">
          ...
          <div class="col-span-6 sm:col-span-4">
            <InputLabel for="account_number" value="Número de cuenta bancaria" />
            <TextInput v-model="bankAccount.account_number" type="text" class="mt-1 block w-full" id="account_number" />
          ...
          <div class="col-span-6 sm:col-span-4">
            ...
            <DynamicSelect v-model="bankAccount.account_type" :options="accountTypeOptions" class="mt-1 block w-full"
              id="account_type" />
          ...
          <div class="col-span-6 sm:col-span-4">
            ...
            <TextInput v-model="bankAccount.current_balance" type="number" min="0" class="mt-1 block w-full"
              id="current_balance" />
    ...
    <template #footer>
      ...
      <PrimaryButton @click="$emit('save')" :disabled="bankAccount.processing"
