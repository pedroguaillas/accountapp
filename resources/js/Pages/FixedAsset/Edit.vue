    ...
    <div class="p-4 bg-white rounded drop-shadow-md">
      ...
      <form @submit.prevent="save" @keydown.enter.prevent="focusNextField">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="grid grid-cols-1 gap-4">
            ...
            <div class="col-span-6 sm:col-span-4">
              ...
              <TextInput v-model="fixedAsset.period" type="number" class="mt-1 block w-full" disabled required />
            ...
            <div class="col-span-6 sm:col-span-4">
              ...
              <TextInput :value="fixedAsset.date_end" v-model="fixedAsset.date_end" type="date"
                class="mt-1 block w-full" disabled required />
        ...
        <div class="flex justify-end items-center space-x-3 mt-4">
          <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-lg" :disabled="fixedAsset.processing">
            Guardar
          </button>
        </div>
      </form>
