...
<template>
  <DialogModal :show="show" maxWidth="lg" @close="$emit('close')">
      ...
      <div class="mt-4">
        <form class="w-2xl grid grid-cols-1 gap-3" @keydown.enter.prevent="focusNextField">
          <div class="col-span-6 sm:col-span-4">
            <InputLabel for="identification" value="Cedula/RUC/Pasaporte" />
            <TextInput v-model="person.identification" type="text" class="mt-1 block w-full" min="1" max="999" />
            <InputError :message="errors.identification" class="mt-2" />
          </div>
          <div class="col-span-6 sm:col-span-4">
            <InputLabel for="name" value="Nombre" />
            <TextInput v-model="person.name" type="text" class="mt-1 block w-full" min="1" max="999" />
            <InputError :message="errors.first_name" class="mt-2" />
          </div>

          <div class="col-span-6 sm:col-span-4">
            <InputLabel for="email" value="Email" />
            <TextInput v-model="person.email" type="text" class="mt-1 block w-full" minlength="3" maxlength="300" />
            <InputError :message="errors.email" class="mt-2" />
          </div>

          <div class="col-span-6 sm:col-span-4">
            <InputLabel for="phone" value="Celular" />
            <TextInput v-model="person.phone" type="text" class="mt-1 block w-full" minlength="3" maxlength="300" />
          ...
          <div class="col-span-6 sm:col-span-4">
            ...
            <TextInput v-model="person.address" type="text" class="mt-1 block w-full" minlength="3" maxlength="300" />
    ...
    <template #footer>
      ...
      <PrimaryButton @click="$emit('save')" :disabled="person.processing"
