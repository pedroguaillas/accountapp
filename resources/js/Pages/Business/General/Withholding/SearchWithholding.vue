...
const selectedWithholding = ref(null); // Nuevo ref para almacenar la selección temporalmente

const handleWithholdingSelect = (withholding) => {
  ...
  withholdingId.value = withholding.id;
